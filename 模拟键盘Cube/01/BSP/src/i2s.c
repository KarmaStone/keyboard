...
DMA_HandleTypeDef I2S3_TXDMA_Handler;   //I2S2发送DMA句柄
DMA_HandleTypeDef I2S3_RXDMA_Handler;   //I2S2接收DMA句柄
...
void I2S2_Init(u32 I2S_Standard,u32 I2S_Mode,u32 I2S_Clock_Polarity,u32 I2S_DataFormat)
{
	...
	I2S3_Handler.Init.Mode=I2S_Mode;					//IIS模式
	I2S3_Handler.Init.Standard=I2S_Standard;			//IIS标准
	I2S3_Handler.Init.DataFormat=I2S_DataFormat;		//IIS数据长度
	I2S3_Handler.Init.MCLKOutput=I2S_MCLKOUTPUT_DISABLE;	//主时钟输出使能
	I2S3_Handler.Init.AudioFreq=I2S_AUDIOFREQ_16K;	//IIS频率设置
	I2S3_Handler.Init.CPOL=I2S_Clock_Polarity;			//空闲状态时钟电平
	HAL_I2S_Init(&I2S3_Handler); 
	
	SPI3->CR2|=1<<1;									//SPI2 TX DMA请求使能.
	I2S3ext->CR2|=1<<0;									//I2S2ext RX DMA请求使能.
	__HAL_I2S_ENABLE(&I2S3_Handler);					//使能I2S2	
	__HAL_I2SEXT_ENABLE(&I2S3_Handler);					//使能I2S2ext
}
